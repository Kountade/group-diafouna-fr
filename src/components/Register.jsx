...
import { 
    ...
    Shield, Calculator, Package, CreditCard, Truck, UserCircle
} from 'lucide-react'
...
const ROLES = [
    ...
    { 
        value: 'agent', 
        label: 'Agent', 
        description: 'Gestion des tâches et opérations quotidiennes', 
        level: 50, 
        icon: Users,
        color: 'primary',
        requiresApproval: false,
        ...
        permissions: [
            ...
            'Consultation des éléments assignés'
        ]
    }
]
...
const Register = () => {
    ...
    // Schéma de validation adapté pour admin et agent
        ...
        AxiosInstance.post(`register/`, submitData)
            .then((response) => {
                ...
                if (watchedRole === 'admin') {
                    message = '✅ Inscription réussie ! Compte administrateur créé avec succès.'
                } else {
                    message = '✅ Inscription réussie ! Vous pouvez maintenant vous connecter avec votre compte agent.'
                }
                ...
                <div className="card bg-base-100 shadow-xl border border-primary/20">
                    <div className="card-body p-6">
                        ...
                        <form onSubmit={handleSubmit(submission)}>
                            ...
                            {/* Information sur les permissions selon le rôle */}
                            {selectedRole && (
                            ...
                            {watchedRole === 'admin' && (
                                <div className="alert bg-warning/10 border border-warning/30 text-warning-content mt-4">
                                    <AlertCircle className="h-5 w-5 text-warning" />
                                    <span className="text-sm">
                                        ⚠️ Le rôle Administrateur donne un accès total au système. Veuillez utiliser ce rôle avec précaution.
                                    </span>
                                </div>
                            )}
